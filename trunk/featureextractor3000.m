...
for i = 1 : size( D, 1 )
    ...
    if D( i ).isdir == 0 && (strncmp( D( i ).name( 1 : 3 ) , 'beetle' , 3) )
        %|| strncmp( D( i ).name( 1 : 3 ) , 'bat' , 3) || strncmp( D( i ).name( 1 : 3 ) , 'bird' , 3) || strncmp( D( i ).name( 1 : 3 ) , 'Bone' , 3) || strncmp( D( i ).name( 1 : 3 ) , 'beetle' , 3))
